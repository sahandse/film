...
export const TMDB_BACK    = 'https://image.tmdb.org/t/p/w1280'
...
export const getTmdbKey = (): string => localStorage.getItem('tmdb_key') ?? ''
export const setTmdbKey = (k: string): void => { localStorage.setItem('tmdb_key', k) }
